...
//CODE HERE
foods.forEach((el)=>{
  return el.calories = (el.carbs *4)+(el.protein*4)+(el.fat*9)
})
//////////////////////////////////PROBLEMS 2-4//////////////////////////////////
/*
...
//CODE HERE
const blueProducts = saleProducts.filter((el)=>{
  if(el.color.includes('blue')){
    return true
  }
})
////////////////////PROBLEM 4////////////////////
...
const person = {
  name: 'Joe',
  age: 30,
  jobs: ["Papa Murphy's", 'Underwriter', 'Quality Engineer'],
  birthday: function(){
    this.age += 1
  },
  favorites: {
